...
addpath(genpath('/Users/chenpeiyu/PycharmProjects/SC_FC_Pred/matlab/functions/'))
...
save([working_dir 'hcp_group_ind_effects_pFC_eFC_schaefer200.mat'],'corr_pFC_eFC_hcp','group_effect_hcp','ind_effect_hcp','match_corr_hcp','mismatch_corr_hcp')

load([working_dir 'hcp_group_ind_effects_pFC_eFC_schaefer200.mat'])
...
save([working_dir,'hcpd_group_ind_effects_pFC_eFC_schaefer200.mat'],'corr_pFC_eFC_hcpd','group_effect_hcpd','ind_effect_hcpd','match_corr_hcpd','mismatch_corr_hcpd')

load([working_dir,'hcpd_group_ind_effects_pFC_eFC_schaefer200.mat'])
...
writetable(pFC_eFC_match,[working_dir 'pFC_eFC_match_schaefer200.csv'])
