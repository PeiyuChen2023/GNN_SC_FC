...
dataset_PATH = "/Users/chenpeiyu/PycharmProjects/SC_FC_Pred/matlab/step_03_whole_brain_group_ind_effects/SC_eFC_match.csv"
...
y_low, y_high = 0.17, 0.48
ratio = 1.2
ax.set_xlim([x_left, x_right])
ax.set_ylim([y_low, y_high])
ax.set_yticks(np.arange(0.2 , 0.451, 0.05))
...
plt.savefig("/Users/chenpeiyu/PycharmProjects/SC_FC_Pred/matlab/step_03_whole_brain_group_ind_effects/SC_eFC_match.png", dpi=300, bbox_inches = 'tight')
plt.show()
