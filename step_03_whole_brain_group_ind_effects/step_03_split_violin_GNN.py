...
dataset_PATH = "/Users/chenpeiyu/PycharmProjects/SC_FC_Pred/matlab/step_03_whole_brain_group_ind_effects/pFC_eFC_match.csv"
...
y_low, y_high = 0.4, 0.9
ratio = 1.2
ax.set_xlim([x_left, x_right])
ax.set_ylim([y_low, y_high])
ax.set_yticks(np.arange(0.45, 0.851, 0.1))
...
plt.savefig("/Users/chenpeiyu/PycharmProjects/SC_FC_Pred/matlab/step_03_whole_brain_group_ind_effects/pFC_eFC_match.png", dpi=300, bbox_inches = 'tight')
plt.show()
