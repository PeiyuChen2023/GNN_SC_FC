...
plot_surface(data = data, color_type = 2, atlas = schaefer7_200,
             outpath = paste0(working_dir,'GNN_model/hcp/hcp_pFC_eFC_group_effect_surface_schaefer200'))
...
colnames(data) <- c('label','value')
plot_surface(data = data, color_type = 2, atlas = schaefer7_200, 
             outpath = paste0(working_dir,'GNN_model/hcp/hcp_pFC_eFC_ind_effect_surface_schaefer200'))
...
colnames(data) <- c('label','value')
plot_surface(data = data, color_type = 2, atlas = schaefer7_200,
             outpath = paste0(working_dir,'GNN_model/hcpd/hcpd_pFC_eFC_group_effect_surface_schaefer200'))
...
colnames(data) <- c('label','value')
plot_surface(data = data, color_type = 2, atlas = schaefer7_200, 
             outpath = paste0(working_dir,'GNN_model/hcpd/hcpd_pFC_eFC_ind_effect_surface_schaefer200'))
