...
save([working_dir,'hcp_pFC_eFC_group_ind_effect.mat'],'group_effect_hcp','ind_effect_hcp','group_effect_norm_hcp','ind_effect_norm_hcp')

%-----------
load([working_dir,'hcp_pFC_eFC_group_ind_effect.mat'])
...
writetable(hcp,[working_dir '/hcp_pFC_eFC_group_ind_effect.csv'])
...
save([working_dir,'hcpd_pFC_eFC_group_ind_effect.mat'],'group_effect_hcpd','ind_effect_hcpd','group_effect_norm_hcpd','ind_effect_norm_hcpd')

load([working_dir,'hcpd_pFC_eFC_group_ind_effect.mat'])
load('/Users/chenpeiyu/PycharmProjects/SC_FC_Pred/matlab/data/perm_id_schaefer400.mat')
rand_num = 10000;
% group effects sa-rank correlation spin test
...
writetable(hcpd,[working_dir '/hcpd_pFC_eFC_group_ind_effect.csv'])
...
writecell(sa_rank_raw,[working_dir '/pFC_eFC_group_ind_effect.csv'])

%%
[sa_rank,~,sa_rank_norm] = xlsread('/Users/chenpeiyu/PycharmProjects/SC_FC_Pred/matlab/data/schaefer400_sa_rank.xlsx');
sa_rank_norm(1,1:5) = {'label','group_effect_norm_hcp','ind_effect_norm_hcp','group_effect_norm_hcpd','ind_effect_norm_hcpd'};
sa_rank_norm(2:401,2:5) = num2cell([group_effect_norm_hcp,ind_effect_norm_hcp,group_effect_norm_hcpd,ind_effect_norm_hcpd]);
...
writecell(sa_rank_norm,[working_dir '/pFC_eFC_group_ind_effect_norm.csv'])
